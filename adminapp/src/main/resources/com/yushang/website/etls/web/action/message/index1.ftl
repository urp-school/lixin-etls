              ...
              <div class="maessage_louzhu">
                  <div class="question_sign"><i class="glyphicon glyphicon-question-sign" aria-hidden="true"></i></div>
                    <div class="question_con">
                      AI重塑教与学百度教育推出百度智慧课堂塑教与学百度教育推出百度智慧课堂塑教与学百度教育推出百度智慧课堂塑教与学百度教育推出百度智慧课堂塑教与学百度教育推出百度智慧课堂塑教与学百度教育推出百度智慧课堂。
                    </div>
                </div>
                <div class="question_answer text-right">
                  <span>匿名</span>|
                    <span>2017-12-25&nbsp;12:00</span>
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <div>
                                    <strong>张三：</strong>
                                    <span>
                                        所谓智能教室，就是一个能够方便对教室所装备的视听、计算机、投影、交互白板等声、光、电设备进行控制和操作，有利于师生无缝地接人
                                        资源及从事教与学活动，并能适应包括远程教学在内的多种学习方式，以自然的人机交互为特征的，依靠智能空间技术实现的增强型教室。智能教室具体体现
                                        出装备先进(齐全)、操控便利(自如)、资源丰富(充分)、交互实时(流畅)、教学方式灵活(多样)等特征。
                                    </span>
                                </div>
                                <div class="comment_ans text-right m_t_10 m_b_5">
                                    <span>2017-12-25&nbsp;12:01</span>
                                    <a href="javascript:;">回复</a>
                                    <div class="publish_con">
                                        <form>
                                            <textarea placeholder="回复张三："></textarea>
